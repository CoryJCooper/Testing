document.addEventListener('DOMContentLoaded', () => {
    ...
    //take the 4 values in each winningArrays and plug into squares
...
//add eventListener to each square to trigger checkBoard()
